...
- This slice was decomposed into focused sub-slices sized for a single Codex session.
- Archived original: `archive/slice-3-mapping-conformance.md`
- Sub-slices directory: `slice-3-mapping-conformance/`
