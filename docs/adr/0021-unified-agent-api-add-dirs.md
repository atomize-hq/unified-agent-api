...
#
# Note: Run `make adr-fix ADR=docs/adr/0021-unified-agent-api-add-dirs.md`
...
- Unified Agent API baselines:
  ...
  - `docs/specs/unified-agent-api/capabilities-schema-spec.md` (Standard capability ids:
    `agent_api.exec.add_dirs.v1`)
...
- Verify the canonical owner-doc semantics already exist and remain synchronized:
  ...
  - `docs/specs/unified-agent-api/capabilities-schema-spec.md` (`agent_api.exec.add_dirs.v1`)
...
- Add backend tests proving:
  ...
  - `docs/specs/unified-agent-api/capability-matrix.md` gains the
