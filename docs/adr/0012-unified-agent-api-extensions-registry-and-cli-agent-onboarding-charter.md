# ADR-0012 — Unified Agent API extensions registry + CLI agent onboarding charter
#
# Note: Run `make adr-fix ADR=docs/adr/0012-unified-agent-api-extensions-registry-and-cli-agent-onboarding-charter.md`
...
- `make adr-check ADR=docs/adr/0012-unified-agent-api-extensions-registry-and-cli-agent-onboarding-charter.md`
