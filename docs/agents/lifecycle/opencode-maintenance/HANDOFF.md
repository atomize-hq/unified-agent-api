...
- prompt sha256: `ea6d7f8347d5bbfa529378e5f25a0a5651269a6fb797bf0865fab9f7ab3a6edb`
...
- branch linkage: `automation/opencode-maintenance-1.15.0`
...
- `cli_manifests/opencode/snapshots/1.15.0/**`
- `cli_manifests/opencode/reports/1.15.0/**`
- `cli_manifests/opencode/versions/1.15.0.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.15.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.15.0`)
...
Execute the automated maintenance packet for `opencode` target `1.15.0`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.15.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.15.0/`, `cli_manifests/opencode/reports/1.15.0/`, and `cli_manifests/opencode/versions/1.15.0.json` as required by the packet.
