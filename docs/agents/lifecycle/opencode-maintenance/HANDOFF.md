...
- branch linkage: `automation/opencode-maintenance-1.15.3`
...
- `cli_manifests/opencode/snapshots/1.15.3/**`
- `cli_manifests/opencode/reports/1.15.3/**`
- `cli_manifests/opencode/versions/1.15.3.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.15.3`
- notes:
