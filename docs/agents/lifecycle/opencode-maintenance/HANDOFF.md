...
- prompt sha256: `af68ebcd8a7bf6b5e84a2a088995ad999adb92e3f32f296689fef4d165fc1f82`
...
- branch linkage: `automation/opencode-maintenance-1.15.6`
...
- `cli_manifests/opencode/snapshots/1.15.6/**`
- `cli_manifests/opencode/reports/1.15.6/**`
- `cli_manifests/opencode/versions/1.15.6.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.15.6`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.15.6`)
...
Execute the automated maintenance packet for `opencode` target `1.15.6`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.15.6` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.15.6/`, `cli_manifests/opencode/reports/1.15.6/`, and `cli_manifests/opencode/versions/1.15.6.json` as required by the packet.
