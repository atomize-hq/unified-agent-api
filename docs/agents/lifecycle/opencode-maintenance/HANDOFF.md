...
- target_version: `1.15.9`
- latest_stable: `1.15.10`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.15.9`
...
- prompt sha256: `4469c80d779f0449a1cef891e5eae0e7e811422e0e5b9d4d99d0adad167a7808`
...
- `cli_manifests/opencode/snapshots/1.15.9/**`
- `cli_manifests/opencode/reports/1.15.9/**`
- `cli_manifests/opencode/versions/1.15.9.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.15.9`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.15.9`)
...
Execute the automated maintenance packet for `opencode` target `1.15.9`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.15.9` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.15.9/`, `cli_manifests/opencode/reports/1.15.9/`, and `cli_manifests/opencode/versions/1.15.9.json` as required by the packet.
