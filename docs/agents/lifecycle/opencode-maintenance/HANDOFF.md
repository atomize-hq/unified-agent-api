...
- target_version: `1.15.10`
- latest_stable: `1.15.11`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.15.10`
...
- prompt sha256: `7472373639963cae1e5b068880eb0d6bc57412efcda68311699a51afafffaa71`
...
- branch linkage: `automation/opencode-maintenance-1.15.10`
...
- `cli_manifests/opencode/snapshots/1.15.10/**`
- `cli_manifests/opencode/reports/1.15.10/**`
- `cli_manifests/opencode/versions/1.15.10.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.15.10`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.15.10`)
...
Execute the automated maintenance packet for `opencode` target `1.15.10`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.15.10` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.15.10/`, `cli_manifests/opencode/reports/1.15.10/`, and `cli_manifests/opencode/versions/1.15.10.json` as required by the packet.
