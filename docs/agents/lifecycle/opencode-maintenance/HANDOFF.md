...
- prompt sha256: `b202517272cdbdee3d00d296a29c6031ee246328673c7cfd1d694f2fd2880214`
...
- branch linkage: `automation/opencode-maintenance-1.15.4`
...
- `cli_manifests/opencode/snapshots/1.15.4/**`
- `cli_manifests/opencode/reports/1.15.4/**`
- `cli_manifests/opencode/versions/1.15.4.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.15.4`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.15.4`)
...
Execute the automated maintenance packet for `opencode` target `1.15.4`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.15.4` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.15.4/`, `cli_manifests/opencode/reports/1.15.4/`, and `cli_manifests/opencode/versions/1.15.4.json` as required by the packet.
