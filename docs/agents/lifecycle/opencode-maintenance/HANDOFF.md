...
- target_version: `1.14.51`
- latest_stable: `1.15.0`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.14.51`
...
- prompt sha256: `4eea372dcdb120e1fa743df68344e154c901f91c43bf78e6ec20d8dfc1d876a3`
...
- branch linkage: `automation/opencode-maintenance-1.14.51`
...
- `cli_manifests/opencode/snapshots/1.14.51/**`
- `cli_manifests/opencode/reports/1.14.51/**`
- `cli_manifests/opencode/versions/1.14.51.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.14.51`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.14.51`)
...
Execute the automated maintenance packet for `opencode` target `1.14.51`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.14.51` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.14.51/`, `cli_manifests/opencode/reports/1.14.51/`, and `cli_manifests/opencode/versions/1.14.51.json` as required by the packet.
