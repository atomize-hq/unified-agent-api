...
- target_version: `1.15.11`
- latest_stable: `1.15.12`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.15.11`
...
- prompt sha256: `84fb9106830831dc6d10ec20154b766b7f91ba1c294c4b41204f1089398f39eb`
...
- `cli_manifests/opencode/snapshots/1.15.11/**`
- `cli_manifests/opencode/reports/1.15.11/**`
- `cli_manifests/opencode/versions/1.15.11.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.15.11`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.15.11`)
...
Execute the automated maintenance packet for `opencode` target `1.15.11`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.15.11` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.15.11/`, `cli_manifests/opencode/reports/1.15.11/`, and `cli_manifests/opencode/versions/1.15.11.json` as required by the packet.
