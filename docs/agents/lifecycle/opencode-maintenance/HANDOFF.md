...
- target_version: `1.18.29`
- latest_stable: `1.18.30`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.29`
...
- prompt sha256: `a2377f38da4919dd428de3ce6a89d12f403841a3e352e882f315f99fa031a120`
...
- branch linkage: `automation/opencode-maintenance-1.18.29`
...
- `cli_manifests/opencode/snapshots/1.18.29/**`
- `cli_manifests/opencode/reports/1.18.29/**`
- `cli_manifests/opencode/versions/1.18.29.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.29`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.29`)
...
Execute the automated maintenance packet for `opencode` target `1.18.29`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.29` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.29/`, `cli_manifests/opencode/reports/1.18.29/`, and `cli_manifests/opencode/versions/1.18.29.json` as required by the packet.
