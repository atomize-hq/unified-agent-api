...
- prompt sha256: `cfd23c2ec2088096f54fe43e90d91b9f87b07ed7b31490f9ae3a4b4e6c42e8e5`
...
- branch linkage: `automation/codex-maintenance-0.153.4`
...
- `cli_manifests/codex/snapshots/0.153.4/**`
- `cli_manifests/codex/reports/0.153.4/**`
- `cli_manifests/codex/versions/0.153.4.json`
...
- reopen pr branch: `automation/codex-maintenance-0.153.4`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.153.4`)
...
Execute the automated maintenance packet for `codex` target `0.153.4`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.153.4` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.153.4/`, `cli_manifests/codex/reports/0.153.4/`, and `cli_manifests/codex/versions/0.153.4.json` as required by the packet.
