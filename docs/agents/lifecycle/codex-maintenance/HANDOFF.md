...
- prompt sha256: `b0070cea88bf0ad5915fa556508fcba3b36931e83b9ade88b1ddb558f13dc473`
...
- branch linkage: `automation/codex-maintenance-0.134.0`
...
- `cli_manifests/codex/snapshots/0.134.0/**`
- `cli_manifests/codex/reports/0.134.0/**`
- `cli_manifests/codex/versions/0.134.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.134.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.134.0`)
...
Execute the automated maintenance packet for `codex` target `0.134.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.134.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.134.0/`, `cli_manifests/codex/reports/0.134.0/`, and `cli_manifests/codex/versions/0.134.0.json` as required by the packet.
