...
- target_version: `2.1.157`
- latest_stable: `2.1.158`
...
- branch_name: `automation/claude_code-maintenance-2.1.157`
...
- prompt sha256: `39b851b36e27bbad2cc48169f355cfd94a7c7b3848f0eff1b8bf434a519f493e`
...
- branch linkage: `automation/claude_code-maintenance-2.1.157`
...
- `cli_manifests/claude_code/snapshots/2.1.157/**`
- `cli_manifests/claude_code/reports/2.1.157/**`
- `cli_manifests/claude_code/versions/2.1.157.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.157`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.157`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.157`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.157` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.157/`, `cli_manifests/claude_code/reports/2.1.157/`, and `cli_manifests/claude_code/versions/2.1.157.json` as required by the packet.
