...
- target_version: `2.1.158`
- latest_stable: `2.1.159`
...
- branch_name: `automation/claude_code-maintenance-2.1.158`
...
- prompt sha256: `02a1abf39390f1305a2f9f6d32b3a86bb0ef0dc5fb3df84cd6d4dbb59c0b253d`
...
- branch linkage: `automation/claude_code-maintenance-2.1.158`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.158`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.158`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.158`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.158` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.158/`, `cli_manifests/claude_code/reports/2.1.158/`, and `cli_manifests/claude_code/versions/2.1.158.json` as required by the packet.
