...
- target_version: `2.1.141`
- latest_stable: `2.1.142`
...
- branch_name: `automation/claude_code-maintenance-2.1.141`
...
- prompt sha256: `b6e89741f126318778f7cc845028511f0509bda1691603a9055f5c1f1568a5ba`
...
- branch linkage: `automation/claude_code-maintenance-2.1.141`
...
- `cli_manifests/claude_code/snapshots/2.1.141/**`
- `cli_manifests/claude_code/reports/2.1.141/**`
- `cli_manifests/claude_code/versions/2.1.141.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.141`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.141`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.141`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.141` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.141/`, `cli_manifests/claude_code/reports/2.1.141/`, and `cli_manifests/claude_code/versions/2.1.141.json` as required by the packet.
