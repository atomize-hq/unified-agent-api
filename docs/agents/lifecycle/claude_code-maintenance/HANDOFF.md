...
- target_version: `2.1.147`
- latest_stable: `2.1.148`
...
- branch_name: `automation/claude_code-maintenance-2.1.147`
...
- branch linkage: `automation/claude_code-maintenance-2.1.147`
...
- `cli_manifests/claude_code/snapshots/2.1.147/**`
- `cli_manifests/claude_code/reports/2.1.147/**`
- `cli_manifests/claude_code/versions/2.1.147.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.147`
- notes:
