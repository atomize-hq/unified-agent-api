...
- target_version: `2.1.144`
- latest_stable: `2.1.145`
...
- branch_name: `automation/claude_code-maintenance-2.1.144`
...
- branch linkage: `automation/claude_code-maintenance-2.1.144`
...
- `cli_manifests/claude_code/snapshots/2.1.144/**`
- `cli_manifests/claude_code/reports/2.1.144/**`
- `cli_manifests/claude_code/versions/2.1.144.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.144`
- notes:
