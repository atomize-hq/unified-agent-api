...
- target_version: `2.1.152`
- latest_stable: `2.1.153`
...
- branch_name: `automation/claude_code-maintenance-2.1.152`
...
- prompt sha256: `c9c73b611ba148ca1d16a1e70e73ca216c81dee488f0867d4a8792d64c7ec6f0`
...
- branch linkage: `automation/claude_code-maintenance-2.1.152`
...
- `cli_manifests/claude_code/snapshots/2.1.152/**`
- `cli_manifests/claude_code/reports/2.1.152/**`
- `cli_manifests/claude_code/versions/2.1.152.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.152`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.152`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.152`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.152` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.152/`, `cli_manifests/claude_code/reports/2.1.152/`, and `cli_manifests/claude_code/versions/2.1.152.json` as required by the packet.
