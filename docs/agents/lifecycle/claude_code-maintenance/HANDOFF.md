...
- branch_name: `automation/claude_code-maintenance-2.1.150`
...
- prompt sha256: `b083ac5d041a577e67aab12b451dc268a461a446de8c31913df7a8551464347d`
...
- branch linkage: `automation/claude_code-maintenance-2.1.150`
...
- `cli_manifests/claude_code/snapshots/2.1.150/**`
- `cli_manifests/claude_code/reports/2.1.150/**`
- `cli_manifests/claude_code/versions/2.1.150.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.150`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.150`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.150`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.150` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.150/`, `cli_manifests/claude_code/reports/2.1.150/`, and `cli_manifests/claude_code/versions/2.1.150.json` as required by the packet.
