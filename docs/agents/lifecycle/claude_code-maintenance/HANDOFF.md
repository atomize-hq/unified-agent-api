...
- prompt sha256: `7e76c412f1b977432eeb64e8775f7f774c361b2c7dff25fa8e02008b7e896435`
...
- branch linkage: `automation/claude_code-maintenance-2.1.149`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.149`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.149`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.149`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.149` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.149/`, `cli_manifests/claude_code/reports/2.1.149/`, and `cli_manifests/claude_code/versions/2.1.149.json` as required by the packet.
