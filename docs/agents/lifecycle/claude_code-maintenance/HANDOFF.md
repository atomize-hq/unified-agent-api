...
- target_version: `2.1.145`
- latest_stable: `2.1.146`
...
- branch_name: `automation/claude_code-maintenance-2.1.145`
...
- prompt sha256: `2a69687bde4dca7acfd3bdd3c738a3bc65cf9c99ef677b7801d9d110ca973bbe`
...
- branch linkage: `automation/claude_code-maintenance-2.1.145`
...
- `cli_manifests/claude_code/snapshots/2.1.145/**`
- `cli_manifests/claude_code/reports/2.1.145/**`
- `cli_manifests/claude_code/versions/2.1.145.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.145`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.145`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.145`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.145` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.145/`, `cli_manifests/claude_code/reports/2.1.145/`, and `cli_manifests/claude_code/versions/2.1.145.json` as required by the packet.
