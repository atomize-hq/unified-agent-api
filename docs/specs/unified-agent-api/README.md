...
- `docs/specs/unified-agent-api/acquisition-maintenance-lifecycle-spec.md` — in-flight work closing
  the gap between parity acquisition and the maintenance/closeout lifecycle. Its §8.1 carries the
  known debt (`uaa-0023`–`uaa-0026`) that the audit-status gate left behind.
