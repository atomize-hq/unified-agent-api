...
//! - [`CodexClient::check_execpolicy`] to evaluate shell commands against Starlark execpolicy files with repeatable `--rules` flags, optional pretty JSON, and parsed decision output (allow/prompt/forbidden or noMatch).
